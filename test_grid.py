...
def test_boundary_ring_containment():
    """Sub-cell containment must hold exactly."""
...
if __name__ == "__main__":
    test_subdiv_factor()
    test_boundary_ring_containment()
    test_build_scene_pipeline()
    test_out_of_range_point()
